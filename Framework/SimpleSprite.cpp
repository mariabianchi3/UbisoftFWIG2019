...
//-----------------------------------------------------------------------------
CSimpleSprite::CSimpleSprite(const char *fileName)
{
...
{            
    ...
    float scalex = m_scale / APP_VIRTUAL_WIDTH * 2; // coordinates are going from "0/virtual Width" to "-1 / 1", so scale goes from 0-VirtualWidth to 0-2
    float scaley = m_scale / APP_VIRTUAL_HEIGHT * 2;
#else
